...
function CreateProduct() {
    ...
    function handleSubmit(event) {
        event.preventDefault();
        //alert(consumable)
        axios.post('https://ghaacademy.com.ng/createProduct', { name, category, consumable, traceable, description, expiration, threshold, serial_number, isbn, barcode, subject, pub_brand, reorder_url }).then(res => {
            console.log(res);
            navigate(-1);
        }).catch(err => console.log(err));
    }
