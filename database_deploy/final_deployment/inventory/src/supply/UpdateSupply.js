...
function UpdateSupply() {
    ...
    useEffect(() => {
        axios.get('https://ghaacademy.com.ng/product').then(res => setAllProducts(res.data))
            .catch(err => console.log(err));
    }, [])

    useEffect(() => {
        axios.get('https://ghaacademy.com.ng/supplier').then(res => setAllSupplier(res.data))
            .catch(err => console.log(err));
    }, [])

    useEffect(() => {
        axios.get('https://ghaacademy.com.ng/unit').then(res => setAllUnit(res.data))
            .catch(err => console.log(err));
    }, [])

    useEffect(() => {
        axios.get(`https://ghaacademy.com.ng/getSupply/${id}`)
            .then(res => {
    ...
    function handleSubmit(event) {
        event.preventDefault();
        axios.put('https://ghaacademy.com.ng/updateSupply/' + id, { product, supplier, unit, quantity, expiry_date, serial_number, isbn, barcode, remark, supply_date }).then(res => {
            console.log(res);
            navigate('/supply');
        }).catch(err => console.log(err));
    }
