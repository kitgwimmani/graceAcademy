...
function CreateUser() {
    ...
    function handleSubmit(event) {
        event.preventDefault();
        axios.post('https://ghaacademy.com.ng/createUser', { name, email, role }).then(res => {
            console.log(res);
            navigate(-1);
        ...
        <div className='d-flex vh-100  justify-content-center align-items-center'>
            <div className='w-50 bg-white rounded p-3'>
                <form onSubmit={handleSubmit}>
                    <h2>Add User</h2>
                    <div className='mb-2'>
                        <label htmlFor=''><label className='required'>* </label>Name</label>
                        <input type='text'
                    ...
                    <div className='mb-2'>
                        <label htmlFor='role'><label className='required'>* </label>Role</label>
                        <Select
                            options={roleOptions}
