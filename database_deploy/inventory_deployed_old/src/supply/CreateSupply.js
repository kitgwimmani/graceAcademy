...
function CreateSupply() {
    ...
    useEffect(() => {
        axios.get(`https://ghaacademy.com.ng/getProduct/${id}`).then(res => {
    ...
    function handleSubmit(event) {
        event.preventDefault();
        axios.post('https://ghaacademy.com.ng/createSupply', { product, supplier, unit, quantity, expiry_date, serial_number, isbn, barcode, remark, supply_date }).then(res => {
            console.log(res);
