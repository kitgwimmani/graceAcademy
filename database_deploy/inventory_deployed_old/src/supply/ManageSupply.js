...
function ManageSupply() {
    ...
    function handleSubmit(event) {
        event.preventDefault();
        axios.post('https://ghaacademy.com.ng/moveItem', { id, location, custodian, unit, dateMoved, dateExpected, quantity }).then(res => {
            //alert(res);
            navigate(0);
        }).catch(err => console.log(err));
    }
    ...
    function handleSubmit2(event) {
        event.preventDefault();
        axios.post('https://ghaacademy.com.ng/moveItem', { location, custodian, unit, dateMoved, dateExpected, quantity }).then(res => {
            console.log(res);
            navigate(-1);
        }).catch(err => console.log(err));
    }
    ...
    function handleSubmitDamage(event) {
        event.preventDefault();
        axios.post('https://ghaacademy.com.ng/reportDamage', { unit, quantity}).then(res => {
            console.log(res);
            navigate(-1);
        }).catch(err => console.log(err));
    }
