...
function CreateSupply() {
    ...
    function handleSubmit(event) {
        event.preventDefault();
        axios.post('https://graceaaapi.cloudsync.com.ng/createSupply', { product, supplier, unit, quantity, expiry_date, serial_number, isbn, barcode, remark, supply_date }).then(res => {
            console.log(res);
            navigate(-1);
        }).catch(err => console.log(err));
    }
