...
function UpdateSupply() {
  ...
  useEffect(() => {
    ...
    useEffect(() => {
        axios.get(`https://graceaaapi.cloudsync.com.ng/getSupply/${id}`)
            .then(res => {
    ...
    function handleSubmit(event){
        event.preventDefault();
        axios.put('https://graceaaapi.cloudsync.com.ng/updateSupply/'+id, {product, supplier, unit, quantity, expiry_date,serial_number,isbn,barcode,remark,supply_date}).then(res => {
            console.log(res);
            navigate('/supply');
        }).catch(err => console.log(err));
    }
